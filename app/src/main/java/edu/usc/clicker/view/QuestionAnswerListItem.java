...
public class QuestionAnswerListItem extends RecyclerView.ViewHolder implements View.OnClickListener {
    LinearLayout view;
    TextView letter;
    TextView answer;
    QuestionAnswerListAdapter adapter;
    int num;
    ...
    public QuestionAnswerListItem(View itemView, QuestionAnswerListAdapter adapter) {
        super(itemView);
